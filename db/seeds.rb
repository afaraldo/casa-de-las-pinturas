...
# Crear un empleado
@empleado = Persona.create nombre: 'Laura Perez', direccion:'Nuevo circuito comercial', telefono: '0985123456', numero_documento: '1234567-8',  tipo: "Empleado", limite_credito: 0, user_attributes: { username: 'admin', password: 'Admin+123' } if User.find_by_username('admin').nil?
