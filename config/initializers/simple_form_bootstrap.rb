...
SimpleForm.setup do |config|
  ...
  # Wrapper para radio y checkboxes con btn-group
  config.wrappers :button_radio_and_checkboxes, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly

    b.use :label, class: 'control-label'

    b.wrapper tag: 'div', class: 'btn-group', html: {data: {toggle: 'buttons'}} do |ba|
      ba.use :input
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
    end
